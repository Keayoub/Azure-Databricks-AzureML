...
│
├── docs/                         ← Documentation
│   ├── DEPLOYMENT-PROCESS.md    ← Complete deployment guide
...
│   ├── main.bicepparam          ← Encrypted parameters
│   │
...
│       ├── validate.ps1         ← (NEW) Pre-flight checks
│       ├── postprovision.ps1    ← (ENHANCED) Metastore creation
│       ├── postdeploy.ps1       ← (ENHANCED) UC deployment
│       └── ... (other scripts)
│
└── terraform/                   ← Databricks Config (Terraform)
    ├── TERRAFORM-README.md      ← (NEW) Start here for Terraform
    ...
    │   ├── outputs.tf
    │   ├── providers.tf
    │   └── (terraform.tfvars)   ← Auto-generated by postprovision
    │
    ├── environments/            ← Layer 2: Workspace UC components
    │   ├── main.tf
    │   ├── variables.tf
    │   ├── outputs.tf
    │   ├── providers.tf
    │   ├── terraform.tfvars     ← Auto-generated by postdeploy
    │   └── tfplan               ← Built during apply
    │
    ├── modules/                 ← Reusable Terraform modules
    │   ├── adb-uc-catalogs/    ← Create catalogs/schemas
    │   │   ├── main.tf
    │   │   ├── variables.tf
    │   │   ├── outputs.tf
    │   │   ├── README.md
    │   │   └── examples.tf
    │   │
    │   └── adb-uc-volumes/     ← Create external volumes
    │       ├── main.tf
    │       ├── variables.tf
    │       ├── outputs.tf
    │       ├── README.md
...
## 🗂️ Getting Started: Where to Look
...
### ⚙️ "I need to deploy or change something"
...
# ✅ Done! Check Databricks workspace
```
...
# ✅ Check Databricks catalog browser
```
...
**⚠️ Warning:** This destroys data in external volumes. See [DEPLOYMENT-PROCESS.md](../docs/DEPLOYMENT-PROCESS.md) before doing this.
...
**Tools:**
- 🛠️ Bicep IaC language
- 📝 Configuration: `infra/main.bicepparam`
- 🏃 Executed by: `azd provision`
...
**Tools:**
- 🛠️ Terraform + Databricks provider (account-level)
- 📝 Configuration: `terraform/metastore/`
- 🏃 Executed by: `infra/scripts/postprovision.ps1` (during azd provision)
...
**Tools:**
- 🛠️ Terraform + Databricks provider (workspace-level)
- 📝 Configuration: `terraform/environments/`
- 🏃 Executed by: `azd deploy` → `infra/scripts/postdeploy.ps1`
...
→ [DEPLOYMENT-PROCESS.md#troubleshooting](../docs/DEPLOYMENT-PROCESS.md#troubleshooting)

**"How do I deploy?"**
→ [QUICKSTART.md](../QUICKSTART.md)

**"Terraform isn't working"**
→ [terraform/TERRAFORM-README.md#troubleshooting](../terraform/TERRAFORM-README.md#troubleshooting)

**"Where do I find X?"**
→ [terraform/INDEX.md](../terraform/INDEX.md)

**"What resources get created?"**
→ [README.md#-what-gets-deployed](../README.md#-what-gets-deployed)

**"How is it secured?"**
→ [README.md#-security-features](../README.md#-security-features)

**"What changed from before?"**
→ [ENHANCEMENTS-SUMMARY.md](ENHANCEMENTS-SUMMARY.md)
